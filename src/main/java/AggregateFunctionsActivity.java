 ...
 *
 * Aggregate functions in SQL are functions which preform operations on 
 * multiple rows to produce a single output.
 ...
 */
    ...
    public int problem2() {
        /**
         * Problem 2: use the COUNT() aggregate function to output the number 
         * of employees with the last name "Smith".
